...
function Destinations() {
  return (
    <div id="destinations" className="">
      <div>
        <h1 className="lg:text-5xl text-3xl text-center font-bold font-mono text- pt-8 text-green-700">
          Popular Destinations
        </h1>
        <p className="lg:text-sm text-xm text-center font-bold font-mono text-black pt-2">
          Take a peak at what Kerala can offer to you..
        </p>
      </div>
      <div className=" px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between px-16 bg-gradient-to-r bg-green-800 border-black rounded-lg">
          <div className="lg:w-2/5 w-full px-7">
            <h1 className="lg:text-4xl text-2xl flex items-start font-medium mx-4 mt-5 font-mono text-white">
              Munnar
            </h1>
            <p className="px-4 pt-5 text-white">
            ...
            <div className="flex items-center w-full justify-center mt-6">
              <button className=" bg-white text-black bg-transparent  rounded-full text-sm font-medium px-5  py-2 h-full hover:bg-green-600 transition-all duration-500">
                Plan Trip
              </button>
            </div>
          </div>
      ...
      <div className=" px-8 mt-4">
        <div className="flex flex-col lg:flex-row items-center justify-between px-16 bg-gradient-to-r bg-[#256783] border-black rounded-lg">
          <div className="lg:w-2/5 w-full px-7">
            <h1 className="lg:text-4xl text-2xl flex items-start font-medium mx-4 mt-5 font-mono text-white">
              Varkala
            </h1>
